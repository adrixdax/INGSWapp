...
public class InsertFilmReviewScreenTest {
    ...
    @Test
    public void emptyTitleAndGoodValutationAtMin() throws Exception {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview("", 0.5f);
        });
        assertEquals(TitleException.TOO_SHORT.toString(),exception.getMessage());
    }

    @Test
    public void emptyTitleAndGoodValutationAtMax() throws Exception {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview("", 5.0f);
        });
        assertEquals(TitleException.TOO_SHORT.toString(),exception.getMessage());
    }
    ...
    public void tooLongTitleAndGoodValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview("Mamma mia sto film è troppo bello", 0.5f);
        });
    ...
    public void tooLongTitleAndGoodValutationAtMax() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview("Mamma mia sto film è troppo bello", 5.0f);
        });
        assertEquals(TitleException.TOO_LONG.toString(),exception.getMessage());
    }
    ...
    public void TitleIsANumberAndGoodValutationAtMin(){
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs((int)randomNumber())), 0.5f);
        });
    ...
    public void TitleIsANegativeNumberAndGoodValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs((int)randomNumber())*-1), 0.5f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsANegativeNumberAndGoodValutationAtMax() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs((int)randomNumber())*-1), 5.0f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsPositiveFloatAndGoodValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs(randomNumber())), 0.5f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsNegativeFloatAndGoodValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs(randomNumber())*-1), 0.5f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsNegativeFloatAndGoodValutationAtMax() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs(randomNumber())*-1), 5.0f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsANumberAndInvalidValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs((int)randomNumber())), 0.0f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsANegativeNumberAndInvalidValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs((int)randomNumber())*-1), 0.0f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsPositiveFloatAndInvalidValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs(randomNumber())), 0.0f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
    ...
    public void TitleIsNegativeFloatAndInvalidValutationAtMin() {
        Exception exception = assertThrows(Exception.class, ()-> {
            screen.isValidReview(String.valueOf(Math.abs(randomNumber())*-1), 0.0f);
        });
        assertEquals(TitleException.IS_NUMBER.toString(),exception.getMessage());
    }
